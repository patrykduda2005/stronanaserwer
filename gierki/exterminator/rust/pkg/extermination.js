...
* @returns {number}
*/
export function get_array_components_amount() {
    const ret = wasm.get_array_components_amount();
    return ret >>> 0;
}
...
export class JsCommunicator {
    ...
    */
    get_turn_number() {
        const ret = wasm.jscommunicator_get_turn_number(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    */
    advance_turn() {
        wasm.jscommunicator_advance_turn(this.__wbg_ptr);
    }
    /**
    */
    update_client_state() {
        wasm.jscommunicator_update_client_state(this.__wbg_ptr);
    }
    /**
    */
    update_map() {
